...
public class VtMdmAaKwhDetail {
	...
	private String way;//按线路1，按计量点2
	
	private String important;//是否重点设备
	...
	public void setVeeEstmtDetail(String veeEstmtDetail) {
		this.veeEstmtDetail = veeEstmtDetail = veeEstmtDetail == null ? null : veeEstmtDetail.trim();
	}
	...
	public void setVeeEditDetail(String veeEditDetail) {
		this.veeEditDetail = veeEditDetail = veeEditDetail == null ? null : veeEditDetail.trim();
	}  
