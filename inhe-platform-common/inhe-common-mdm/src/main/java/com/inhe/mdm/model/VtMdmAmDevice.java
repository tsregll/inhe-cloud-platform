...
public class VtMdmAmDevice {
    ...
    private String devNumName;
    
    private String tmDescription;//变压器名称
    
    private String substationDescription;//变电站名称
    
    private String lineDescription;//线路名称
    
    private String substationMtName;//主变名称
	...
	public String getDevNumName() {
		return devNumName;
	}

	public void setDevNumName(String devNumName) {
		this.devNumName = devNumName == null ? null : devNumName.trim();
	}
	...
	public void setTmDescription(String tmDescription) {
		this.tmDescription = tmDescription == null ? null : tmDescription.trim();
	}
	...
	public void setSubstationDescription(String substationDescription) {
		this.substationDescription = substationDescription == null ? null : substationDescription.trim();
	}
	...
	public String getSubstationMtName() {
		return substationMtName;
	}

	public void setSubstationMtName(String substationMtName) {
		this.substationMtName = substationMtName == null ? null : substationMtName.trim();
	}  
}
