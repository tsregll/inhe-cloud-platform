...
public class VtMdmAmTm {
    ...
    private String tmCodeName;//变压器编号和名称合并
    
    private String lineDescription;//所属线路名称
	...
	public String getTmCodeName() {
		return tmCodeName;
	}

	public void setTmCodeName(String tmCodeName) {
		this.tmCodeName = tmCodeName == null ? null : tmCodeName.trim();
	}
